...
public class NormalGoodTest {
    ...
    public void should_reduce_one_when_get_good_updatedQuality_and_updatedSelIn_given_one_day_passed() {
        ...
        NormalGood normalGood1 = new NormalGood(10, 20);
        NormalGood normalGood2 = new NormalGood(3, 6);

        Assert.assertEquals(9, normalGood1.getUpdatedSellIn(1));
        Assert.assertEquals(19, normalGood1.getUpdatedQuality(1));

        Assert.assertEquals(2, normalGood2.getUpdatedSellIn(1));
        Assert.assertEquals(5, normalGood2.getUpdatedQuality(1));
    }
